...
#define CF_REG_DATA			REG_MPCF_DATA
#define CF_REG_STATUS		REG_MPCF_STS
#define CF_REG_COMMAND		REG_MPCF_CMD
#define CF_REG_ERROR		REG_MPCF_ERR
#define CF_REG_SECTOR_COUNT	REG_MPCF_SEC
#define CF_REG_LBA1			REG_MPCF_LBA1
#define CF_REG_LBA2			REG_MPCF_LBA2
#define CF_REG_LBA3			REG_MPCF_LBA3
#define CF_REG_LBA4			REG_MPCF_LBA4
